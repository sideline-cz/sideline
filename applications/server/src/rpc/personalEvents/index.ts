...
export const PersonalEventsRpcLive = Effect.Do.pipe(
  ...
  Effect.map((deps) => ({
    ...
    }) => deps.messages.getPersonalEventMessage(event_id, team_member_id),
    ...
    'PersonalEvents/DeletePersonalEventMessage': ({
      ...
      readonly event_id: Event.EventId;
      readonly team_member_id: TeamMember.TeamMemberId;
    }) => deps.messages.deletePersonalEventMessage(event_id, team_member_id),
    ...
    'PersonalEvents/ListMessagesForMember': ({
      ...
      readonly team_member_id: TeamMember.TeamMemberId;
    }) => deps.messages.listMessagesForMember(team_member_id),
  })),
