...
- Updated dependencies [[`ee68d21`](https://github.com/maxa-ondrej/sideline/commit/ee68d215ab1a26accc771119c3249b99aa6c9c71)]:
  - @sideline/migrations@0.12.9
...
- [#201](https://github.com/maxa-ondrej/sideline/pull/201) [`945a950`](https://github.com/maxa-ondrej/sideline/commit/945a95000a9015b148caa4cd38da9bbef3efdbf9) Thanks [@maxa-ondrej](https://github.com/maxa-ondrej)! - Add owner group Discord channel as 4th fallback in resolveChannel so event notifications are sent to group channels when no other channel is configured
...
- [#180](https://github.com/maxa-ondrej/sideline/pull/180) [`0bd7e64`](https://github.com/maxa-ondrej/sideline/commit/0bd7e64c932b435ca0afdc052b5e9a2aa2451304) Thanks [@maxa-ondrej](https://github.com/maxa-ondrej)! - Fix SQL error when updating event series with null end_time. Added explicit `::time` cast in CASE WHEN clause so PostgreSQL can determine the parameter type.
...
- [#170](https://github.com/maxa-ondrej/sideline/pull/170) [`28bdc5d`](https://github.com/maxa-ondrej/sideline/commit/28bdc5d1ae3986e2bf3f1d242656a4315707e903) Thanks [@maxa-ondrej](https://github.com/maxa-ondrej)! - Fix channel mapping not being deleted when archive cleanup mode is used on group/roster channel unlink
...
- Updated dependencies [[`8d97865`](https://github.com/maxa-ondrej/sideline/commit/8d978654612cab81032e51a3e602ddcf07918ac0)]:
  - @sideline/domain@0.14.0
  - @sideline/migrations@0.12.1
